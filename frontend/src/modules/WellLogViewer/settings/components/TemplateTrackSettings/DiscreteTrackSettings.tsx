...
import { WellboreGeoHeader_api, WellborePicksAndStratigraphicUnits_api } from "@api";
...
import { TrackSettingFragmentProps } from "./TrackSettings";

import { TemplatePlotConfig } from "../../atoms/persistedAtoms";
import { wellboreGeologyHeadersQueryAtom, wellborePicksAndStratUnitsQueryAtom } from "../../atoms/queryAtoms";
...
export function DiscreteTrackSettings(props: TrackSettingFragmentProps): React.ReactNode {
    ...
    const picksAndStratQuery = useAtomValue(wellborePicksAndStratUnitsQueryAtom);

    const { activeQuery, selectOptions } = makeCurveOptions(activeSource, geoHeadersQuery, picksAndStratQuery);
    ...
    return (
        <>
            ...
            <Dropdown
                ...
                // @ts-expect-error Dropdown fails to limit return typing
...
function makeCurveOptions(
    ...
    layerdataQuery: QueryObserverResult<WellborePicksAndStratigraphicUnits_api, Error>
    ...
    switch (chosenSource) {
        ...
        case "stratigraphy":
            return {
                selectOptions: makeStratigraphyOptions(layerdataQuery.data?.stratigraphic_units ?? []),
                activeQuery: layerdataQuery,
            };
        // case "welllog":
